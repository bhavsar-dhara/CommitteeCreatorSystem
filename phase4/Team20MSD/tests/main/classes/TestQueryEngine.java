...
//	}
	...
	public void testGetAuthorCommitteeDetailsByAuthorName(){
		QueryEngine qe = new QueryEngine();
		Author authorToTest = new Author(/*needs data*/);
		ArrayList<Author> committeeDetailsFound = new ArrayList<>(qe.getAuthorCommitteeDetailsByAuthorName(authorToTest));
		ArrayList<Author> actualCommitteeDetails = new ArrayList<>(/*needs data*/);
