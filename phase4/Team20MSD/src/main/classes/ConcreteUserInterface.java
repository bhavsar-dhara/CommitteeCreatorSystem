...
public class ConcreteUserInterface implements UserInterface {
	...
	public void displayCandidateList() {
		CandidateListPage clp = new CandidateListPage(this);
		CandidateListPage.setStage(clp);
		CandidateListPage.showStage();
	}
	...
	public ObservableList<Author> getAuthorExperience(Author atr) {
		return FXCollections.observableArrayList(qe.getAuthorCommitteeDetailsByAuthorName(atr));
	}

	@Override
	public String getAuthorSchool(Author atr) {
		return qe.getAuthorUnivDetails(atr);
	}
